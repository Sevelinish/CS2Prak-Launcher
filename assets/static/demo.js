...
(function () {
    ...
    const CINE_POS_TOL = 72;      
    const CINE_ANG_TOL = 3;       

    const CINE_LEAD = 1.5;        
    const CINE_HOLD = 1.1;        
    const CINE_TAIL = 0.6;        
    const CINE_MOVE = 0.75;       
    const CINE_TAU  = 0.20;       
    const CINE_NEAR = 3.4;        
    const CINE_FLY  = 2.4;        
    const CINE_WIDE = 1.5;        
    ...
    function cinePaintShot(s) {
        ...
        playerAvatar(p.steamid).then(fp => {
            if (!fp || !cine || tok !== cine.token) return;   
